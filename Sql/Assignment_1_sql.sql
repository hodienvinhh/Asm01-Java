...
NOTE VARCHAR(50) DEFAULT 'I am User',
...
VALUES ('Hà Nội'    ,'ngoctai@gmail.com'    , 'Phạm Ngọc Tài'   , 'I am Admin ' , '$2a$12$05jIkU5Nd0zbMvRi/7vlfOpIJuAIlq3htfGXk9sR5Y47MxozEHmd6'  , '0914453588' ,    1     ,  'ngoctai'    , 'CREATE OK',   1   ),
 ...
 VALUES    ('D001'  , '2023-05-20'  , 'Donationed D001' , '2023-05-20', '2023-10-11',  0    , 'Ủng hộ lũ lụt Miền Trung'       , ' Sức mạnh 2000'        , '0945.942.468',  1),
           ('D002'  , '2023-06-19'  , 'Donationed D002' , '2023-06-19', '2024-12-15',  0    , 'Nụ cười trẻ thơ'                , ' Quỹ vì tầm vóc Việt'  , '0989.394.901',  0),
           ('D003'  , '2023-06-19'  , 'Donationed D003' , '2023-06-19', '2023-10-10',  0    , 'Giúp trẻ em vùng cao đến trường', ' Momo'                 , '0911.724.666',  1),
           ('D004'  , '2023-05-27'  , 'Donationed D004' , '2023-05-27', '2023-08-11',  0    , 'Lắp đặt hệ thống nước sạch'     , ' Qũy từ thiện Hoa Hồng', '0948.443.555',  1),
           ('D005'  , '2023-04-20'  , 'Donationed D005' , '2023-04-20', '2023-12-05',  0    , 'Quỹ nâng bước tuổi thơ'         , ' Momo'                 , '0394.783.649',  1),
           ('D006'  , '2023-05-20'  , 'Donationed D006' , '2023-05-20', '2025-12-09',  0    , 'Giúp đỡ trẻ em nghèo'           , ' Bảo trợ trẻ em'       , '0911.373.918',  0),
           ('D007'  , '2023-06-25'  , 'Donationed D007' , '2023-06-25', '2023-09-25',  0    , 'Giúp đỡ người già neo đơn'      , ' Hỗ trợ người già'     , '0837.870.888',  0),
           ('D008'  , '2023-06-20'  , 'Donationed D008' , '2023-06-20', '2024-05-30',  0    , 'Quỹ khuyến học vùng cao'        , ' Vì tương lai Việt Nam', '0368.676.324',  2),
           ('D009'  , '2023-05-01'  , 'Donationed D009' , '2023-05-01', '2023-11-07',  0    , 'Xây cầu vùng cao Tây Bắc'       , ' Quỹ hi vọng'          , '02323514678' ,  1),
           ('D0010' , '2023-05-29'  , 'Donationed D0010', '2023-05-29', '2023-07-25',  0    , 'Thư viện ước mơ'                , ' Thư viện ước mơ'      , '0915.420.289',  2);
           
 -- CREATE DATA USER_DONATION
 INSERT INTO 
    USER_DONATION ( CREATED     ,  MONEY  ,   `NAME`          , DATE_DONATION , `STATUS` , `TEXT`   , DONATION_ID , USER_ID)
 VALUES           ('2023-05-30' , 100000  , 'Trần Bảo Minh'   , '2023-05-30'  ,    0     , 'Ủng hộ' ,     1       ,    2  ),
                  ('2023-06-30' , 500000  , 'Nguyễn Minh Tân' , '2023-06-30'  ,    0     , 'Ủng hộ' ,     6       ,    3  ),
                  ('2023-08-30' , 100000  , 'Phạm Gia Khánh'  , '2023-08-30'  ,    0     , 'Ủng hộ' ,     2       ,    5  ),
                  ('2023-09-30' , 200000  , 'Phạm Đăng Nguyên', '2023-09-30'  ,    0     , 'Ủng hộ' ,     2       ,    6  ),
                  ('2023-10-30' , 120000  , 'Lê Hoàng Nam'    , '2023-10-30'  ,    0     , 'Ủng hộ' ,     8       ,    2  ),
                  ('2023-05-26' , 110000  , 'Phạm Anh Thư'    , '2023-05-26'  ,    0     , 'Ủng hộ' ,     3       ,    6  ),
                  ('2023-07-30' , 100000  , 'Hồ Diên Nhật Lâm', '2023-07-30'  ,    0     , 'Ủng hộ' ,     4       ,    1  ),
                  ('2023-07-30' , 100000  , 'Phan Thanh Bình' , '2023-07-30'  ,    0     , 'Ủng hộ' ,     9       ,    4  ),
                  ('2023-05-30' , 100000  , 'Bùi Phương Thảo' , '2023-05-30'  ,    0     , 'Ủng hộ ',     5       ,    5  );   